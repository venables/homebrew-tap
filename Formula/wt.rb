class Wt < Formula
  ...
  url "https://github.com/venables/wt/archive/refs/tags/v0.6.0.tar.gz"
  sha256 "e382c800548857906526e8ed6a5d29e057d9eb2a0824ce654095921dd62e5ecf"
  license "MIT"
  ...
  test do
    assert_match "wt 0.6.0", shell_output("#{bin}/wt --version")
  end
end
