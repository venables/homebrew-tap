class Wt < Formula
  ...
  url "https://github.com/venables/wt/archive/refs/tags/v0.7.0.tar.gz"
  sha256 "d741d39926e7f52b1804eae09ccdfebc23f230dcd2b8a065fe4d560070350875"
  license "MIT"
  ...
  test do
    assert_match "wt 0.7.0", shell_output("#{bin}/wt --version")
  end
end
